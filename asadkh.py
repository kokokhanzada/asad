import os try: import requests except ImportError: print '\n X> The requests module is not installed (requests) !...\n' os.system('pip2 install requests')

try: import concurrent.futures except ImportError: print '\n X> The requests module is not installed (futures) !...\n' os.system('pip2 install futures')

try: import bs4 except ImportError: print '\n X> The requests module is not installed (bs4) !...\n' os.system('pip2 install bs4')

def tik(): titik = [' ', '10% ', '20% ', '40% ', '60% ', '80% ', 'Done '] for o in titik: print '\n \r\x1b[1;91m [*] \x1b[0;32mWAIT FEW SECONDS OPENING \x1b[1;97m' + o, sys.stdout.flush() time.sleep(0.5)

import requests, os, re, bs4, sys, json, time, random, datetime from concurrent.futures import ThreadPoolExecutor as YayanGanteng from datetime import datetime from bs4 import BeautifulSoup ct = datetime.now() n = ct.month bulan = ['Januari', 'Februari', 'Maret', 'April', 'Mei', 'Juni', 'Juli', 'Agustus', 'September', 'Oktober', 'November', 'Desember'] try: if n < 0 or n > 12: exit() nTemp = n - 1 except ValueError: exit()

current = datetime.now() ta = current.year bu = current.month ha = current.day op = bulan[nTemp] reload(sys) sys.setdefaultencoding('utf-8') P = '\033[0m' M = '\033[0m' H = '\033[0m' K = '\033[0m' B = '\033[0m' U = '\033[0m' O = '\033[0m' N = '\033[0m' my_color = [ P, M, H, K, B, U, O, N] warna = random.choice(my_color) ok = [] cp = [] id = [] user = [] loop = 0 xi_jimpinx = '1714000985456399' koh = '100005395413800' hoetank = random.choice(['Yang posting orang nya ganteng:)', 'Lo ngentod:v', 'Never surrentod tekentod kentod:v']) bulan_ttl = {'01': 'Januari', '02': 'Februari', '03': 'Maret', '04': 'April', '05': 'Mei', '06': 'Juni', '07': 'Juli', '08': 'Agustus', '09': 'September', '10': 'Oktober', '11': 'November', '12': 'Desember'}

def jalan(z): for e in z + '\n': sys.stdout.write(e) sys.stdout.flush() time.sleep(0.03)

def tod(): titik = ['\x1b[1;92m. ', '\x1b[1;93m.. ', '\x1b[1;96m... ', '\x1b[1;92m. ', '\x1b[1;93m.. ', '\x1b[1;96m... '] for x in titik: print '\r %s[%s+%s] Removed Token %s' % (N, N, N, x), sys.stdout.flush() time.sleep(1)

logo =""" \x1b[0;91m * \033[1;0m \x1b[0;91m ( * ) \033[1;0m \x1b[0;91m )\))( ( ) /( \033[1;0m \x1b[0;91m(()()\ )\ ( )()) \033[1;0m \x1b[0;91m(()(() ((|(()) \033[1;0m\tMajestic \x1b[0;94m _ _ _ _ _ _ \033[1;0m \x1b[1;94m| / | | |_ | \033[1;0m \x1b[1;94m| |/| | || | | | \033[1;0m \x1b[1;94m|| ||_/ |_| \033[1;0m \n\x1b[1;97m===========\x1b[1;97m=========================================== \033[1;96m[!]\033[1;97mADMIN\x1b[1;97m : \x1b[1;97mKOKOKHANADA \033[1;96m[!]\033[1;97mVersion\x1b[1;97m : \x1b[1;97m3.3.3 \033[1;96m[!]\033[1;97mFb\x1b[1;97m : \x1b[1;97mASAD \x1b[1;97m===========\x1b[1;97m=========================================== """

lo_ngentod = '1714009362122228'

def yayanxd(): os.system('clear') kontol = raw_input('\n%s[%sX%s] Enter Token :%s ' % (N, M, N, H)) if kontol in ('fuck', 'Fuck', 'FUCK'): os.system('clear') print logo print '_____________________________________________________\n' raw_input(' \n%sX%s Enter Token : ' % (O, N)) os.system('xdg-open https://m.facebook.com/composer/ocelot/async_loader/?publisher=feed#_=_') yayanxd() try: Name = requests.get('https://graph.facebook.com/me?access_token=%s' % kontol).json()['name'] print '\n\n %sX%s Welcome To Fucking World %s%s%s' % (O, N, K, Name, N) time.sleep(2) open('.memek.txt', 'w').write(kontol) wuhan(kontol) os.system('xdg-open https://youtu.be/2NKmiCZSIAA') moch_yayan() except KeyError: print '\n Invalid Token / ReLogin' time.sleep(2) yayanxd()

def moch_yayan(): os.system('clear') try: kontol = open('.memek.txt', 'r').read() except IOError: print '\n %s[%sO>%s] Login Page ...' % (N, M, N) time.sleep(2) os.system('rm -rf .memek.txt') yayanxd()
...
try:
    ...
    Asad_khan()
def publik2(kontol): try: os.mkdir('dump') except: pass
...
try:
    ...
    raw_input(' [ %sBack%s ] ' % (O, N))
    Asad_khan()
def publik3(kontol): try: os.mkdir('dump') except: pass
...
try:
    ...
    raw_input(' [ %sBack%s ] ' % (O, N))
    moch_yayan()
def publik4(kontol): filePath = '/sdcard/mjt_75.txt'; if os.path.exists(filePath): os.remove(filePath) ids = '/sdcard/ids_friends.txt' os.system('cat /sdcard/ids_friends.txt | grep "100075" >> /sdcard/mjt_75.txt') time.sleep(2) print ' [\033[1;37;40m\x1b[0m] \tGetting 100075 ids Wait While.....\x1b[0m' time.sleep(5) print ' [\033[1;37;40m\x1b[0m] \t100075 ids saved in /sdcard/mjt_75.txt\x1b[0m' time.sleep(5) moch_yayan()

if name == 'main': os.system('git pull') Asad_khan()
